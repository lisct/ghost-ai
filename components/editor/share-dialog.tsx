  ...
  return (
    <Dialog open={open} onOpenChange={(o) => { if (!o) onClose() }}>
      <DialogContent className="rounded-3xl sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-lg text-white">Share Project</DialogTitle>
        </DialogHeader>
...
function CollaboratorRow({ collaborator, isOwner, isRemoving, onRemove }: CollaboratorRowProps) {
  return (
    <li className="flex items-center gap-3 rounded-xl px-2 py-1.5">
      <Avatar name={collaborator.displayName} imageUrl={collaborator.imageUrl} />
